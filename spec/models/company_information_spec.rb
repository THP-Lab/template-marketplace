...
RSpec.describe CompanyInformation, type: :model do
  it "returns the shipping price for the first matching weight tier" do
    ...
    company_information.shipping_rates.create!(max_weight: 1.0, price: 4.5)
    company_information.shipping_rates.create!(max_weight: 3.0, price: 7.9)
  ...
  it "falls back to the highest shipping tier when the total weight exceeds all thresholds" do
    company_information = CompanyInformation.instance
    company_information.shipping_rates.create!(max_weight: 2.0, price: 6.0)
    company_information.shipping_rates.create!(max_weight: 5.0, price: 9.5)
